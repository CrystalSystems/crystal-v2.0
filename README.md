...
**Composition:** <br/>
Package.json: [frontend](https://github.com/CrystalSystems/crystal-v2.0/blob/main/main/frontend/package.json) | [backend](https://github.com/CrystalSystems/crystal-v2.0/blob/main/main/backend/package.json)<br/>
